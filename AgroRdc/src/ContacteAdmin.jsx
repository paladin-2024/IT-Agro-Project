                ...
                <section className="flex flex-col justify-center p-6 md:p-10 bg-white">
                    <div className="max-w-md mx-auto w-full space-y-8">
                        <div className="md:hidden flex flex-col items-center mb-8 space-y-1">
                            <span className="material-symbols-outlined text-primary text-[48px]">support_agent</span>
                        ...
                        <form className="space-y-5" onSubmit={handleSubmit}>
                            ...
                            <div className="space-y-1">
                                ...
                                <select
                                    ...
                                    className="w-full px-4 py-3 bg-white border border-outline rounded-lg outline-none focus:ring-2 focus:ring-primary focus:border-primary transition"
                                >
                                    <option value="acces_compte">Accès / compte utilisateur</option>
                                    <option value="droits_role">Droits / rôle sur le hub</option>
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-xs text-outline">
                                    Utilisez &quot;Critique&quot; uniquement si l&apos;activité de terrain est bloquée.
                                </p>
                            </div>
                            ...
                            <div className="space-y-1">
                                ...
                                <textarea
                                    ...
                                    value={form.message}
                                    onChange={handleChange}
                                    placeholder="Décrivez brièvement le problème, l'accès demandé ou la modification souhaitée..."
